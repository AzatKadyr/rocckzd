<div>
<button type="button" id="addrest" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#staticBackdrop" >+Ресторан</button>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="staticBackdropLabel">Добавление ресторана</h5>
