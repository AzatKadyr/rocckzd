...
?>
  ...
  <head>
    ...
    <link href="http://bootstrap-4.ru/docs/4.1/examples/album/album.css" rel <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
...
<script type="text/javascript" src="js/app.js"></script>-->
    ...
    <style>
      body {
        background-image: url(/img/image/fon.jpg);
      ...
      .category1 {
        ...
        width: 35px;
        color: #fff;
        background-image: url(/img/image/pb.png);
        border-radius: 0;
      ...
      .category2 {
        ...
        width: 35px;
        color: #fff;
        background-image: url(/img/image/sb.png);
        border-radius: 0;
        background-size: cover;
      }
      ...
      .category3 {
        ...
        width: 35px;
        color: #fff;
        background-image: url(/img/image/lb.png);
        border-radius: 0;
        background-size: cover;
      }
      ...
      .level2 {
        ...
        width: 35px;
        color: #fff;
        background-image: url(/img/image/l2.png);
        border-radius: 0;
        background-size: cover;
      }
      ...
      .level3 {
        ...
        width: 35px;
        color: #fff;
        background-image: url(/img/image/l3.png);
        border-radius: 0;
        background-size: cover;
      }
  ...
  <body>
    ...
    <header>
      ...
      <div class="row">
        <div class="col-10"><img src="/img/image/logoreport.png" class="img-fluid" alt="ROCC онлайн система"></div>
...
?>
        ...
        <table class="table table-bordered">
          ...
          <tbody id="roccinfo">
            <tr>
              <td>
                <?php echo $data['info']['rocc_id']?>
              </td>
              <td>
                <?php echo $data['info']['restid']?> |
                  <?php echo $data['info']['rest_name']?>
              </td>
              <td>
                <?php echo $data['info']['rocc_opentime']?>
              </td>
              <td>
                <?php echo $data['info']['auditor_name']?>
              </td>
              <td>
                <?php echo $data['info']['rocc_statusname']?>
              </td>
            </tr>
          </tbody>
        </table>
          ...
          <center>
            <thead>
              <tr>
                ...
                <th scope="col">
                  <center>Короткая информация</center>
                </th>
                <th scope="col"> </th>
              </tr>
            </thead>
        ...
        ?>
                <tr>
                  <td>
                    <center><img src="<?php echo $item['otkl_img_cat'];?>" height="35px" width="35px"></center>
                  </td>
                  <td>
                    <center>
                      <?php
      	...
      	?>
                  ...
                  <td>
                    <center>
                      <?php echo $item['otkl_mintext'];?>
                    </center>
                  </td>
                  <td>
                    <center><img src="<?php echo $item['otkl_img_subcat'];?>" height="35px" width="35px"></center>
                  </td>
                </tr>
